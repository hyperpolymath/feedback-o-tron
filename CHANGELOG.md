...
All notable changes to `feedback-o-tron` will be documented in this file.
...
- feat: comprehensive repo improvements — error types, rate limiting, retry, BGP/RPKI, tests, CI
- feat: comprehensive repo improvements — tests, docs, credential persistence
- feat(crg): add crg-grade and crg-badge justfile recipes
- feat: add soft Groove manifest with passive mode and dogfood-feedback capability
