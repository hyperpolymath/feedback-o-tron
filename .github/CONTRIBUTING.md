...
git clone <https://github.com/hyperpolymath/feedback-o-tron.git> cd
feedback-o-tron
...
toolbox create feedback-o-tron-dev toolbox enter feedback-o-tron-dev \#
Install dependencies manually

# Verify setup

just lint \# compile clean and check formatting just test \# Run test
suite


    ### Repository Structure

feedback-o-tron/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \#
...
flake (Perimeter 1) └── Justfile \# Task runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github.com/hyperpolymath/feedback-o-tron/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/feedback-o-tron/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/feedback-o-tron/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/feedback-o-tron/labels/perimeter-3) — Community sandbox scope
