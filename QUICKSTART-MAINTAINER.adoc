...
= Feedback O Tron — Maintainer Quickstart
:toc: preamble
...
* Git 2.40+
* just (command runner)
* Familiarity with the project (read README.adoc and run `just --list` first)
...
[source,bash]
----
podman build -f Containerfile -t feedback-o-tron:latest .
----
