...
Install Git, Elixir and gh from the distribution first -- that is what the
project tests against and what receives security updates. A bare container or a
freshly imaged machine has none of the four:
