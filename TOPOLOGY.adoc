...
. *Honesty rule*: a bar only reaches 100% when the code exists, is wired
in, and does what the row says. "`Aspirational`" boxes get a low bar and
a note — never a full bar. No universal "`100% Production Ready`" rows.
