{
  description = "feedback-o-tron - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 feedback-o-tron development environment"
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P feedback-o-tron.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/feedback-o-tron $out/bin/  # Rust
            # cp bin/feedback-o-tron $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/feedback-o-tron";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-feedback-o-tron" {
